// ════════════════════════════════════════════════════════════════════
// SERVICE WORKER — Gastos Casa (PWA)
// ════════════════════════════════════════════════════════════════════
...
// (son dinámicas: los gastos que carga la otra persona) — esas van siempre
// a la red para no mostrar datos viejos.
//
...
const CACHE = 'gastoscasa-20260728-211135';
...
self.addEventListener('fetch', e => {
  ...
  // NUNCA tocar Supabase: dejar pasar directo a la red (datos en vivo).
